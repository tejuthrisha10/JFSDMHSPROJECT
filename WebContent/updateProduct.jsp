				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="embroidary"
								<%="embroidary".equalsIgnoreCase(ptype) ? "selected" : ""%>>EMBROIDARY</option>
							<option value="ornaments"
								<%="ornaments".equalsIgnoreCase(ptype) ? "selected" : ""%>>ORNAMENTS</option>
							<option value="leather crafts"
								<%="leather crafts".equalsIgnoreCase(ptype) ? "selected" : ""%>>LEATHER CRAFTS</option>
							<option value="metal crafts"
								<%="metal crafts".equalsIgnoreCase(ptype) ? "selected" : ""%>>METAL CRAFTS</option>
							<option value="wood cravings"
								<%="wood cravings".equalsIgnoreCase(ptype) ? "selected" : ""%>>WOOD CRAVINGS</option>
							<option value="pottery"
								<%="pottery".equalsIgnoreCase(ptype) ? "selected" : ""%>>POTTERY</option>
							<option value="other"
